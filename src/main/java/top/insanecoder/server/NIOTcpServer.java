...
public class NIOTcpServer {
    ...
    private static ByteBuffer byteBuffer = ByteBuffer.allocate(10240); // NIO缓存数据结构buffer
    private static int number = 0;

    public static void main(String[] args) throws IOException {

        ServerSocketChannel serverSocketChannel = ServerSocketChannel.open();  // 打开NIO的socket服务器
